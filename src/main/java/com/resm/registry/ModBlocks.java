...
public class ModBlocks {
    public static final Block SILVER_ORE = AddItemGroup.registerBlock("silver_ore", new ExperienceDroppingBlock(FabricBlockSettings.copyOf(Blocks.GOLD_ORE)), new AddItemGroup(1).add(ItemGroups.NATURAL, Items.DEEPSLATE_GOLD_ORE, AddItemGroup.targetMode.AFTER));
    public static final Block DEEPSLATE_SILVER_ORE = AddItemGroup.registerBlock("deepslate_silver_ore", new ExperienceDroppingBlock(FabricBlockSettings.copyOf(Blocks.DEEPSLATE_GOLD_ORE)), new AddItemGroup(1).add(ItemGroups.NATURAL, SILVER_ORE.asItem(), AddItemGroup.targetMode.AFTER));
    ...
    public static final Block RAW_SILVER_BLOCK = AddItemGroup.registerBlock("raw_silver_block", new ExperienceDroppingBlock(FabricBlockSettings.create().mapColor(MapColor.IRON_GRAY).instrument(Instrument.BASEDRUM).requiresTool().strength(5.0f, 6.0f)), new AddItemGroup(1).add(ItemGroups.NATURAL, Items.RAW_GOLD_BLOCK, AddItemGroup.targetMode.AFTER));
